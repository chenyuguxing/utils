 ...
 * 汉字转化为全拼，可以返回多音字的读音
 * @author 		  作         者: 张嘉杰
 * @createdate   建立日期：Aug 8, 2012 4:28:10 PM
 * @projectname  项目名称: zjj
 * @packageclass 包及类名: com.zjj.core.commons.PinyinUtils.java
 */
public class PinyinUtils {
	...
	public static void main(String[] args) {
		...
		str = "多音字就是不好解决";
		str = "";
		System.out.println("Spell=" + PinyinUtils.getFullSpell(str));
		System.out.println("Spell=" + PinyinUtils.getFirstSpell(str));
